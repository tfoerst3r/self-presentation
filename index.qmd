...
- I worked in since 2012 as Researcher 
  and touched topics:
  - Scripting (mainly bash)
  - Pre & Postprocessing (mainly python)
  - HPC for scientific computations

- Best Practices for Software Development
  - Git workflow including branching and CI
  - Python Package development

- Advocate for Linux since 2012

:::
::: {.column width=40%}

![](./images/me.png){width=45%}
...
- ML Course at IU (University of Applied Science)
- Workshops (bash, bashly, quarto) at the Datenspuren (C3D2)
